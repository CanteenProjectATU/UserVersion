...
//This is to get the stored password from local storage so we can send it in the put/post requests. It would not be user friendly
//if the canteen staff had to enter the password every time they did an action in one session so this allows us to retrieve the password for local storage
